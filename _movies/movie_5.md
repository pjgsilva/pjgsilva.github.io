...
![nazare](assets/images/flm_5.jpg)
...
A escolha do Robert Powell para protagonista deve ter sido um dos mais bem sucedidos castings de todos os tempos, tendo em conta como tanto a sua interpretação como o seu aspecto físico se colam na perfeição ao imaginário colectivo.

Este foi o primeiro e único filme a que fui assistir "em família". Ficou-me na memória por isso, claro, mas principalmente pela logística. Pela dimensão, o filme era exibido em duas partes (coisa que eu não sabia) e vimos normalmente a primeira parte no Éden (que apropriada esta ligação entre o antigo e o novo testamento 🤔).
